...
| 彩印海报 | 视觉主体、色块轮廓、halftone网点、留白标题 | 报纸美学、信息压缩、视觉锚点 |
...
彩印海报风格是一种报纸美学的现代平面设计风格：

- **核心特征**：找出照片中真正的视觉主体，把照片重新压缩成色块、轮廓、halftone网点
- **视觉元素**：色块、轮廓、halftone网点
- **文字**：简明扼要的标题 + 有文艺范的一两句短句
- **故事感**：报纸美学、信息压缩、视觉锚点、现代平面设计
