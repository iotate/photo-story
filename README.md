# 照片故事多 / Photo Story Style Transformer
保留原图结构，转换视觉风格，讲述不同故事。

## 简介

照片故事多是一个技能，用于将照片转换为不同的艺术风格。核心原则是：**保留原图的主要元素形状和布局，在风格、色彩、细节上进行转换**。

照片是骨架，风格是血肉。此技能让同一张照片穿越不同的视觉材质——颤抖的铅笔线、流动的水彩、留白的白描——每种风格都讲述着不同的故事。
...
| 中国写意 | 纤细墨线、写意勾勒、克制淡彩、计白当黑、现代编辑秩序 | 东方气韵、清雅、留白、诗意 |
| 金箔压纸 | 暖米白纸张、深压印、香槟金箔、纤细描线、向内凹陷 | 奢华、精致、克制、高级质感 |
...
| 浮雕叙事 | 浮雕压印、乳白留白、哑金点缀、博物馆海报感 | 高级、宁静、极简、东方美学 |
| 符号记忆 | 等粗单线、限色专印、线密度层级、大面积留白、纪念海报 | 温暖、亲密、聪明、松弛、记忆符号化 |
...
| 油印版画 | 单色版画、手工印刷、留白、疏密关系、极简克制 | 极简、克制、手工质感、单色美学 |
...
| 童真插画 | 手绘黑线、平涂色块、留白构图、稚拙书写 | 童真、治愈、轻松、独立出版气质 |
...
| 风格 | 特征 | 故事感 |
|-----|------|-------|
| 木刻版画 | 限色木刻、刀刻笔触、柔和配色、大面积留白 | 温暖、安静、治愈、轻盈 |
...
| 鎏金徽章 | 流金珐琅、金属描边、立体徽章、真实工艺感 | 清爽、明亮、精致、收藏感 |
| 透明解析 | 透明结构、剖切分层、工程蓝图、技术图解 | 理性、精密、秩序、未来感 |
| 积木风格 | 3D积木雕塑、圆润体块、治愈配色、isometric空间 | 温柔、轻盈、童趣、精致 |
| 手绘插画 | 寓言叙事、手绘质感、淡色留白、诗性排版 | 温暖、童真、安静、诙谐 |
| 稚拙插画 | 韩式扁平、手绘轮廓、几何概括、童趣配色 | 明快、童趣、亲切、俏皮 |
| 彩印海报 | 极简丝网版画、Halftone网点、2-3种专色、中文标题副文 | 报纸美学、艺术出版、极简克制 |
| 厚涂油画微缩世界 | 极致厚涂、微缩模型、调色刀笔触、鲜艳配色、诗意梦幻 | 阳光明媚、清新温暖、轻松惬意、充满活力 |
| 卡片世界 | 手握卡片、由纸变世界、真实摄影、透视统一、轻微超现实 | 旅行记忆、梦幻真实、诗意叙事 |

### 插画风格

| 风格 | 特征 | 故事感 |
|-----|------|-------|
| 儿童绘本 | 温暖手绘、柔和平涂、清晰轮廓、简约卡通 | 温暖、童趣、天真、想象力 |
| MBE插画 | 深藏青粗轮廓线、极简几何、柔和色调、点缀虚线、主体缩小居中、四周留白 | 现代、简约、扁平、设计感 |
| 童真插画 | 黑色手绘线条、平涂色块、留白构图、稚拙字体 | 童真、聪明、轻松、治愈 |
| 手绘插画 | 寓言叙事、手绘质感、淡色留白、诗性排版 | 温暖、童真、安静、诙谐 |
| 稚拙插画 | 韩式扁平、手绘轮廓、几何概括、童趣配色 | 明快、童趣、亲切、俏皮 |
| 杂志插画 | 极简几何、分层平涂、淡墨晕染、无锐利硬边 | 现代、简约、编辑美学 |
| 水墨插画 | 水墨扁平、块面造型、淡墨晕染、米白纸张 | 东方、禅意、现代、诗意 |

**风格示例：厚涂油画微缩世界**

厚涂油画微缩世界是一种极致厚涂油画技法 + 微缩模型三维景观的诗意梦幻风格：

- **核心特征**：极致厚涂油画技法，将人物、姿态和叙事融入三维微型景观
- **布局比例**：微缩世界占60-75%，留白25-40%，可见白色纸张纹理
- **边缘处理**：自然流畅，羽状或斑点状，柔和融入白纸
- **色彩搭配**：鲜艳明亮，清新天蓝、珊瑚橙、樱桃红、蜜桃粉
- **绘画技巧**：调色刀痕迹、凸起颜料脊、雕塑般立体感
- **故事感**：阳光明媚、清新温暖、轻松惬意、充满活力

<img src="examples/Memorial-Hall-photo.jpg" alt="纪念堂原图" width="45%"> <img src="examples/Memorial-Hall-story_miniworld.png" alt="纪念堂厚涂油画微缩世界风格" width="45%">
...
- **简化原则**：只保留主要内容，删除次要细节
- **配色**：仅限2-3种专色，部分色块可用红、橙、黄、金等暖色调点缀
